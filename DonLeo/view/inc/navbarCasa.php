        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-toggleable-xs" id="collapseEx">
                ...
                <ul class="nav navbar-nav fuente-navSec" style="float: right; padding-top:0.5%;">
                    <li class="nav-item">
                        <a class="nav-link" style="padding-right: 20px;" href="#Nosotros">Historia</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="padding-right: 20px;" href="#Servicios">Descubre Viñedos Don Leo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="padding-right: 20px;" href="#Empresas">Glamour & Tecnología </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="padding-right: 20px;" href="#Contacto">El Vino</a>
                    </li>
