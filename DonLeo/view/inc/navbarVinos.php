        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-toggleable-xs" id="collapseEx">
                ...
                <ul class="nav navbar-nav fuente-navSec" style="float: right; padding-top:0.5%;">
                    <li class="nav-item">
                        <a class="nav-link" style="padding-right: 20px;" href="#Nosotros">Vinos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="padding-right: 20px;" href="#Servicios">Accesorios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="padding-right: 20px;" href="#Empresas">Paquetes </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="padding-right: 20px;" href="#Contacto"></a>
                    </li>
